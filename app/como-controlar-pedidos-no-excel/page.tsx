...
export const metadata: Metadata = {
  title: "Como Controlar Pedidos no Excel",
  description:
  ...
  alternates: {
    canonical: "/como-controlar-pedidos-no-excel",
  },
  keywords: [
    "como controlar pedidos no excel",
    "controle de pedidos no excel",
    "alternativa ao excel",
    "controle de pedidos",
  ],
};

export default function ComoControlarPedidosNoExcelPage() {
  return (
