...
export const metadata: Metadata = {
  title: "Sistema de Orçamento Online vs Planilha",
  description:
  ...
  alternates: {
    canonical: "/sistema-de-orcamento-online-vs-planilha",
  },
  keywords: [
    "sistema de orçamento online vs planilha",
    "orçamento online",
    "planilha",
...
export default function SistemaDeOrcamentoOnlineVsPlanilhaPage() {
  return (
