...
export const metadata: Metadata = {
  title: "Sistema de Pedidos Melhor que Planilha",
  description:
  ...
  alternates: {
    canonical: "/sistema-de-pedidos-melhor-que-planilha",
  },
  keywords: [
...
export default function SistemaDePedidosMelhorQuePlanilhaPage() {
  return (
