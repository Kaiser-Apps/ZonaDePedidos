...
export const metadata: Metadata = {
  title: "Sistema de Pedidos Online Grátis",
  description:
  ...
  alternates: {
    canonical: "/sistema-de-pedidos-online-gratis",
  },
  keywords: [
    "sistema de pedidos online grátis",
...
export default function SistemaDePedidosOnlineGratisPage() {
  return (
