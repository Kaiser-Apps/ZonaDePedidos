...
export const metadata: Metadata = {
  title: "Sistema de Pedidos para Pequenas Empresas",
  description:
  ...
  alternates: {
    canonical: "/sistema-de-pedidos-para-pequenas-empresas",
  },
  keywords: [
...
export default function SistemaDePedidosParaPequenasEmpresasPage() {
  return (
