...
export const metadata: Metadata = {
  title: "Sistema de Pedidos para Serviços",
  description:
  ...
  alternates: {
    canonical: "/sistema-de-pedidos-para-servicos",
  },
  keywords: [
    "sistema de pedidos para serviços",
    "sistema de pedidos",
    "controle de pedidos",
...
export default function SistemaDePedidosParaServicosPage() {
  return (
