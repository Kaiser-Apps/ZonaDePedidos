...
export const metadata: Metadata = {
  title: "Sistema para Enviar Orçamento ao Cliente",
  description:
  ...
  alternates: {
    canonical: "/sistema-para-enviar-orcamento-ao-cliente",
  },
  keywords: [
    "sistema para enviar orçamento ao cliente",
    "enviar orçamento",
    "orçamento online",
...
export default function SistemaParaEnviarOrcamentoAoClientePage() {
  return (
