...
export const metadata: Metadata = {
  title: "Sistema para Prestador de Serviços",
  description:
  ...
  alternates: {
    canonical: "/sistema-para-prestador-de-servicos",
  },
  keywords: [
    "sistema para prestador de serviços",
    "controle de pedidos",
    "orçamento",
...
export default function SistemaParaPrestadorDeServicosPage() {
  return (
