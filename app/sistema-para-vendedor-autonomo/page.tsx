...
export const metadata: Metadata = {
  title: "Sistema para Vendedor Autônomo",
  description:
  ...
  alternates: {
    canonical: "/sistema-para-vendedor-autonomo",
  },
  keywords: [
    "sistema para vendedor autônomo",
    "controle de vendas",
    "controle de pedidos",
    "vendedor",
  ],
...
export default function SistemaParaVendedorAutonomoPage() {
  return (
